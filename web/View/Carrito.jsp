                            ...
                            <div class="container">
                                <table class="table">
                                    <tr style="background-color: #12175E">
                                        <th colspan="9" class="text-center" style="color: white">PRODUCTOS SELECCIONADOS</th>
                                    </tr>
                                    <tr bgcolor="skyblue">
                                        <td>Posicion</td>
                                        <td>Producto</td>
                                    ...
                                    <%
                                                subtotal = subtotal + (d.getPrecio() * d.getCant());
                                            }
                                        }
                                    %>
                                    <tr>
                                        <td align="left" colspan="7">Sub Total:&nbsp; </td>
                                        <td><%=subtotal%></td>
                                        <td align="center">-</td>
                                    </tr>
                                    <tr>
                                        <td align="left" colspan="7">Descuento&nbsp; </td>
                                        <td><%="10%"%></td>
                                        <td align="center">-</td>
                                    </tr>
                                    <%
                                    ...
                                    %>
                                    <tr>
                                        <td align="left" colspan="7">Total a pagar:&nbsp; </td>
                                        <td><%=total%></td>
                                        <td align="center">-</td>
                                    </tr>
                                </table>
